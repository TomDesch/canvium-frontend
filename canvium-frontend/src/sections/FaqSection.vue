  ...
  <div id="faq" class="container mx-auto px-5 md:w-4/5">
    <section class="py-16 pt-18">
      <div class="w-4/5 md:w-3/5 mx-auto">
        ...
        <p class="text-theme-grayish-blue text-center mt-7 font-theme-content text-lg">Here are some of out FAQs. If you have any other quesitons you'd like
        ...
        <ul class="shadow-lg">
          <template v-for="(faq) in faqs" :key="faq.id">
            <li @click="isOpen = faq.id" :class="isOpen === faq.id ? 'text-theme-secondary' : ''"
              ...
              <a href="#">{{ faq.title }}</a>
              <svg :class="isOpen === faq.id ? 'rotate-180 text-theme-secondary' : 'rotate-0 text-theme-primary'" class="transform"
